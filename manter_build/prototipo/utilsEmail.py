...
from utilsArquivos import CAMINHO_RESULTADO_JSON
import os
import pathlib
import smtplib
import email
...
def enviar_email_resultado():
    remetente = '***email_data_cempro@datacempro.com.br'
    destinatario = '***email_pessoal@teste.com.br'

    # Configurações SMTP
    smtp_server = 'email.datacempro.com.br'
    smtp_port = 587
    smtp_username = '***email_data_cempro@datacempro.com.br'
    smtp_password = '***senha e-mail data cempro'
