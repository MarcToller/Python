...
from utilsArquivos import *
import json
from utilsEmail import enviar_email_resultado
import shutil

class GerenciadorBuild: 
    def __init__(self) -> None:
        self.listas = retorna_listas()
        

    def executar_manter_build(self):        
        ...
        lista_executaveis_pesados = self.listas[CHAVE_LISTA_ARQUIVOS_PESADOS]
        lista_executaveis_leves = self.listas[CHAVE_LISTA_ARQUIVOS_LEVES]
        lista_executaveis_medios = self.listas[CHAVE_LISTA_ARQUIVOS_MEDIOS]
        lista_resultados = []
...
teste = GerenciadorBuild()
teste.executar_manter_build()